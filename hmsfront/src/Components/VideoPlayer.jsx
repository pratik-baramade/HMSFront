...
const VideoPlayer = () => {
  return (
    <>
      <div className='container-fluid mt-0 pt-0' style={{ margin: 0, padding: 0 }}>
        <div className='heading'>
        <Heading />
        </div>
        
        <div className=" bg-light py-5 d-flex flex-column justify-content-between">
          <div className="container">
            <div className="row align-items-center flex-column-reverse flex-lg-row py-5">
              {/* Text Content */}
